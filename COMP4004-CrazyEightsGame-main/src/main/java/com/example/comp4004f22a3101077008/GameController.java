...
public class GameController {
    ...
    public StartMessage start(ConnectionMessage message) throws Exception {
        ...
        return new StartMessage("Start", gd.getTopCard().getRank() + gd.getTopCard().getSuit(), "1", cards.get(0), "2",
                cards.get(1), "3", cards.get(2), "4", cards.get(3), String.valueOf(gd.getPlayers().get(0).getScore()),
                String.valueOf(gd.getPlayers().get(1).getScore()), String.valueOf(gd.getPlayers().get(2).getScore()),
                String.valueOf(gd.getPlayers().get(3).getScore()), gd.getDirection(),
                String.valueOf(gd.getCurrentPlayer()));
    }
        ...
        if (car[0].equals("8")) {
            if (gd.getNumTwoPlayed() > 0) {
                ...
                return new PlayMessage("8Played", String.valueOf(id), card.toString(),
                        gd.getTopCard().getRank() + gd.getTopCard().getSuit());
            }
            ...
            if (gd.getNumTurns() > 1) {
                if (gd.getTopCard().getRank().equals("2")) {
                    if (gd.getPlayers().get(id - 1).getTwoPlayed() == 0) {
                        ...
                        return new PlayMessage("1Played", String.valueOf(id), card.toString(),
                                gd.getTopCard().getRank() + gd.getTopCard().getSuit());
                    }
                }
                gd.setNumTwoPlayed(0);
            ...
            switch (res) {
                case "APlayed" -> {
                    ...
                    if (gd.getPlayers().get(id - 1).handSize() == 0) {
                        ...
                        return new PlayMessage("APlayed", String.valueOf(id), card.toString(),
                                String.valueOf(gd.getCurrentPlayer()), gd.getDirection(),
                                gd.getTopCard().getRank() + gd.getTopCard().getSuit());
                    }
                }
                case "Played" -> {
                    ...
                    if (gd.getPlayers().get(id - 1).handSize() == 0) {
                        ...
                        return new PlayMessage("Played", String.valueOf(id), card.toString(),
                                String.valueOf(gd.getCurrentPlayer()),
                                gd.getTopCard().getRank() + gd.getTopCard().getSuit());
                    }
                }
                case "2Played" -> {
                    ...
                    if (gd.getPlayers().get(id - 1).handSize() == 0) {
                        ...
                        for (Card c : gd.getPlayers().get(gd.getCurrentPlayer() - 1).cards) {
                            if (gd.getTopCard().getRank().equals(c.getRank())
                                    || gd.getTopCard().getSuit().equals(c.getSuit()) || tc.getRank().equals(c.getRank())
                                    || tc.getSuit().equals(c.getSuit())) {
                                tc = c;
                                numCards++;
                            }
                        }
                        if (numCards < 2) {
                            ...
                            if (gd.getCards().size() >= 2) {
                                ...
                                gd.setNumTwoPlayed(0);
                                return new PlayMessage("2 Played 1", String.valueOf(id), card.toString(),
                                        String.valueOf(gd.getCurrentPlayer()), card2.toString(),
                                        gd.getTopCard().getRank() + gd.getTopCard().getSuit());
                            } else {
    ...
    private PlayMessage getPlayMessage() {
        ...
        if (checkRound()) {
            ...
            return new PlayMessage("Game Over", String.valueOf(gd.getPlayers().get(0).getScore()),
                    String.valueOf(gd.getPlayers().get(1).getScore()),
                    String.valueOf(gd.getPlayers().get(2).getScore()),
                    String.valueOf(gd.getPlayers().get(3).getScore()), String.valueOf(winner.getID()));
        } else {
            ...
            setNextRound();
            return new PlayMessage("Round Over", String.valueOf(gd.getPlayers().get(0).getScore()),
                    String.valueOf(gd.getPlayers().get(1).getScore()),
                    String.valueOf(gd.getPlayers().get(2).getScore()),
                    String.valueOf(gd.getPlayers().get(3).getScore()), String.valueOf(gd.getNextRound()));
        }
    }
    ...
    public DrawMessage drawCard(ConnectionMessage message) throws Exception {
        ...
        if (gameState) {
            if (gd.getPlayers().get(id - 1).getNumDraws() >= 3) {
                ...
                for (Card c : p.cards) {
                    if (gd.getTopCard().getSuit().equals(c.getSuit())
                            || gd.getTopCard().getRank().equals(c.getRank())) {
                        playable = true;
                    }
                }
                if (playable) {
                    ...
                    setNextTurn();
                    return new DrawMessage("Not Playable", message.getMessage(), card,
                            String.valueOf(gd.getCurrentPlayer()));
                }
            } else {
                Player p = gd.getPlayers().get(id - 1);
            ...
            if (gd.getPlayers().get(id - 1).handSize() == 0) {
                ...
                return new DrawMessage("Game Over", "1", String.valueOf(gd.getPlayers().get(0).getScore()), "2",
                        String.valueOf(gd.getPlayers().get(1).getScore()), "3",
                        String.valueOf(gd.getPlayers().get(2).getScore()), "4",
                        String.valueOf(gd.getPlayers().get(3).getScore()), String.valueOf(gd.getNextRound()),
                        String.valueOf(winner.getID()));
            } else {
                return new DrawMessage("Round Over", "1", String.valueOf(gd.getPlayers().get(0).getScore()), "2",
                        String.valueOf(gd.getPlayers().get(1).getScore()), "3",
                        String.valueOf(gd.getPlayers().get(2).getScore()), "4",
                        String.valueOf(gd.getPlayers().get(3).getScore()), String.valueOf(gd.getNextRound()));
            }
